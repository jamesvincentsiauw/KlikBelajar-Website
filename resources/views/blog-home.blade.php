	...
	<header id="header">
		<div class="container">
			<div class="row align-items-center justify-content-between d-flex">
				<div id="logo">
					<a href="index.blade.php"><img src="img/logo.png" alt="" title="" /></a>
				</div>
				...
				<div class="about-content col-lg-12">
					...
					<div class="link-nav">
						<span class="box">
							...
							<a href="blog-home.blade.php">Blog</a>
						</span>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-8 posts-list">
					<div class="single-post row">
						...
						<div class="col-lg-9 col-md-9 ">
							...
							<a class="posts-title" href="blog-single.blade.php"><h3>Astronomy Binoculars A Great Alternative</h3></a>
							<p class="excert">
								MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money
								on boot camp when you can get the MCSE study materials yourself at a fraction.
							</p>
							<a href="blog-single.blade.php" class="primary-btn">View More</a>
						</div>
					</div>
					<div class="single-post row">
						<div class="col-lg-3  col-md-3 meta-details">
						...
						<div class="col-lg-9 col-md-9 ">
							...
							<a class="posts-title" href="blog-single.blade.php"><h3>The Basics Of Buying A Telescope</h3></a>
							<p class="excert">
								MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money
								on boot camp when you can get the MCSE study materials yourself at a fraction.
							</p>
					...
					<div class="single-post row">
						...
						<div class="col-lg-9 col-md-9">
							...
							<a class="posts-title" href="blog-single.blade.php"><h3>The Glossary Of Telescopes</h3></a>
							<p class="excert">
								MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money
								on boot camp when you can get the MCSE study materials yourself at a fraction.
							</p>
					...
					<div class="single-post row">
						...
						<div class="col-lg-9 col-md-9">
							...
							<a class="posts-title" href="blog-single.blade.php"><h3>The Night Sky</h3></a>
							<p class="excert">
								MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money
								on boot camp when you can get the MCSE study materials yourself at a fraction.
							</p>
					...
					<div class="single-post row">
						...
						<div class="col-lg-9 col-md-9">
							...
							<a class="posts-title" href="blog-single.blade.php"><h3>Telescopes 101</h3></a>
							<p class="excert">
								MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money
								on boot camp when you can get the MCSE study materials yourself at a fraction.
							</p>
						...
						<div class="single-sidebar-widget popular-post-widget">
							...
							<div class="popular-post-list">
								<div class="single-post-list d-flex flex-row align-items-center">
									...
									<div class="details">
										<a href="blog-single.blade.php"><h6>Space The Final Frontier</h6></a>
										<p>02 Hours ago</p>
									</div>
								</div>
								<div class="single-post-list d-flex flex-row align-items-center">
									...
									<div class="details">
										<a href="blog-single.blade.php"><h6>The Amazing Hubble</h6></a>
										<p>02 Hours ago</p>
									</div>
								</div>
								<div class="single-post-list d-flex flex-row align-items-center">
									...
									<div class="details">
										<a href="blog-single.blade.php"><h6>Astronomy Or Astrology</h6></a>
										<p>02 Hours ago</p>
									</div>
								</div>
								<div class="single-post-list d-flex flex-row align-items-center">
									...
									<div class="details">
										<a href="blog-single.blade.php"><h6>Asteroids telescope</h6></a>
										<p>02 Hours ago</p>
									</div>
								</div>
							</div>
