            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title">Daftar Regular Package</h2>
                        ...
                        @endif
                        <form method="post" class="register-form" id="register-form" action="/register/regular">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="package" id="package" value="Regular Package" disabled/>
                            </div>
                            <div class="form-group">
